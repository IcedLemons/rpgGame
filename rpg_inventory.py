...
and rooms that the player can access, it has been updated to house a user inventory.
'''
# ===========================================================================
...
def find():
  '''
  Locates items that are under the room name of the current location and    adds them to inventory list while also removing them from items dictionary.
  ...
  if current_location in items:
    ...
    for item in found_items:
      ...
      spacer()
      print(
        f"You've discovered a {item} within the {current_location.capitalize()}"
      )
      print("-------------------------------")
